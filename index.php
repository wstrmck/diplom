        ...
        <main class="main">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            ...
                            <p>На нашем сайте вы найдёте множество компьютеров по доступным ценам</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h2>Комплектующие</h2>
                            <p>Здесь вы найдёте множество комплектующих</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h2>Ноутбуки</h2>
                            <p>Большой ассортимент ноутбуков под разные задачи</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h2>Мониторы</h2>
                            <p>Различные мониторы на любой вкус и цвет</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h2>Принтеры</h2>
                            <p>Большое количество разнообразных принтеров</p>
                        </div>
                    </div>
                </div>
            ...
            <section class="about-us">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p>Я Гусев Никита Евгеньевич студент 4 курса направления 09.02.07 с квалификацией
                                веб-разработчик разработал данное веб-приложение для интернет-магазина
                                компьютерной техники на дипломный проект</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2709.500510802071!2d39.69724047579612!3d47.22635487115748!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40e3b904ebb47671%3A0x2b24811a37553536!2z0JrRgNCw0YHQvdC-0LDRgNC80LXQudGB0LrQsNGPINGD0LsuLCAxMSwg0KDQvtGB0YLQvtCyLdC90LAt0JTQvtC90YMsINCg0L7RgdGC0L7QstGB0LrQsNGPINC-0LHQuy4sIDM0NDAxMA!5e0!3m2!1sru!2sru!4v1747392252247!5m2!1sru!2sru"
